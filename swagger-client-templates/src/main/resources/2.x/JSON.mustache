/*
 * CAF Grammar Service APIs
 * Manages grammars and entities used by the Entity Extract Worker.
 *
 ...
 */
package com.microfocus.darwin.grammar.client;
...
class CustomizedObjectTypeAdapter extends TypeAdapter<Object>
{
    ...
    {
        System.err.println("RORY in custom ADPATER write with input " + value);
    ...
    {
        System.err.println("RORY in custom ADPATER read...");
        ...
        switch (token) {
            ...
            case NUMBER:
                ...
                System.err.println("RORY in new custom adapter read with input " + n);
                if (n.indexOf('.') != -1) {
